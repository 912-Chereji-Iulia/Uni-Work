...
class TestPersonService(unittest.TestCase):
    def setUp(self):
        list=IterableObject()
        list.add(Person(1, 'Chereji Iulia', '0721389973'))
...
class TestUndoService(unittest.TestCase):
    def setUp(self):
        ...
        list.add( Activity(2, [1, 2, 3], '2020-10-14', '12:40', '13:40', 'dance classes'))
        list.add(Activity(3, [1, 2, 3], '2021-12-20', '12:20', '13:20', 'sport'))
        list.add(Activity(4, [1, 3], '2021-12-20', '12:00', '12:19', 'sport'))
        list.add(Activity(5, [1, 3], '2021-12-21', '12:00', '12:19', 'sport'))
...
class TestActivityService(unittest.TestCase):
    ...
    def test_upcoming_date(self):
        ...
        self.assertEqual(self._service.upcoming_dates("2020-12-08", '23:59'), False)

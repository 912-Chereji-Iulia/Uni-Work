...
class UI:
    ...
    def print_menu(self):
        ...
        print("17. Lowest cost walk between the given vertices, using a backwards Dijkstra algorithm")
        print("0.Exit ")
            ...
            try:
                ...
                if cmd == 0:
                    ...
                    try:
                        ...
                        dist, walk = self._graph.lowest_cost_walk_with_backward_Dijkstra(v1, v2)
                        print(f'The minimum cost is {dist}')
                        for vertex in walk:
                            print(vertex, end=' ')
                        print('\n')
